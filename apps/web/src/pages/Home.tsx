      ...
      <div className="relative flex-1 flex flex-col justify-center px-8 lg:px-16 xl:px-24 py-16 lg:py-0 border-r border-neutral-200 dark:border-neutral-800 bg-white dark:bg-[#0a0a0a]">
        ...
        <div className="max-w-xl">
          <h1 className="text-6xl lg:text-[72px] font-medium tracking-[-0.03em] leading-[1.05] mb-6">
            On-Chain Payroll
            <br />
            <span className="text-neutral-400 dark:text-neutral-500">Wallet Entry</span>
          </h1>

          <p className="text-lg text-neutral-500 dark:text-neutral-400 mb-8 leading-relaxed max-w-md font-light">
            Connect a Starknet wallet, verify Sepolia network, and continue to execute payroll batches.
          </p>
          ...
          <div className="border-t border-neutral-200 dark:border-neutral-800 pt-8">
            <p className="text-[11px] font-medium text-neutral-400 dark:text-neutral-500 mb-6 tracking-[0.1em] uppercase">
            ...
            <div className="flex items-center gap-12 opacity-60 grayscale">
              ...
              <div className="text-2xl font-bold flex items-center gap-1">
                <span className="text-3xl leading-none">*</span> Cairo
              </div>
